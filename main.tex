...
% Analytical Regrasp Using Energy-base modeling.
% 抓取是提前已知的，在可控范围内选出来的，预测是Grasp的label, 所以称为analytical. 最好加上learning与analytical形成冲突对比，让读者有兴趣读下去

% two-dimensional manifolds
\author{Liang Qin$^{1}$, Weiwei Wan$^{1*}$, and Kensuke Harada$^{1}$
...
\thanks{The work was supported by a joint project between The University of Osaka and H. U. Group Research Institute. ${}^1$L. Qin, W. Wan, and K. Harada are with Graduate School of Engineering Science, The University of Osaka, Japan. ${}^2$J. Takahashi, R. Negishi, and M. Matsushita are with H.U. Group Research Institute G.K., Japan. ${}^{*}$Contact: Weiwei Wan, {wan.weiwei.es@osaka-u.ac.jp}. Digital Object Identifier (DOI):}}
...
\section{Energy-Based Reorientation Planning}
% 有不少方向
